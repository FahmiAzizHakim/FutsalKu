        ...
        <h3>Data Lapangan</h3>
            <form role="form">
                ...
                <div class="form-group">
                    ...
                    <input id="field_no" name="field_no" type="text" class="form-control" readonly="readonly" />
                </div>
                <div class="form-group">
                    <label>Ruangan</label>
...
<script type="text/javascript">
    var field_name = "{$fielddata.field_name}";
    var field_no = "{$fielddata.field_no}";
    var field_room = "{$fielddata.field_room}";
    var field_type = "{$fielddata.field_type}";
    var field_ball = "{$fielddata.field_ball}";
    var activestatus ="{$fielddata.activestatus}";
    var field_book_price = "{$fielddata.field_book_price}";

    {literal}

    $(function(){
        $("#field_name").val(field_name);
        $("#field_no").val(field_no);
        $("#field_book_price").val(field_book_price);
        
        //refresh selectpicker
        $("#field_room").val(field_room);
        $("#field_type").val(field_type);
        $("#field_ball").val(field_ball);
    ...
    {literal}
        ...
        $.ajax({
            type: "POST",
            url: api_url + "Master_data/field_update",
            dataType: "json",
